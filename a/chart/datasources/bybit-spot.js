const BybitSpotDatafeed = {
    ...
    async fetchSymbols() {
        ...
        this.symbolsCache = data.result.list
            ...
            .map(s => {
                ...
                return {
                    symbol: s.symbol,
                    full_name: `Bybit Spot:${s.symbol}`,
                    description: `${s.baseCoin}/${s.quoteCoin}`,
                    exchange: 'Bybit Spot',
                    type: 'crypto',
    ...
    async getBars(symbolInfo, resolution, periodParams, onHistoryCallback, onErrorCallback) {
        try {
            ...
            const url = `${this.baseUrl}/v5/market/kline?category=spot&symbol=${symbolInfo.ticker}&interval=${interval}&start=${from * 1000}&end=${to * 1000}&limit=1000`;
