class SymbolSelector {
    ...
    async loadSymbols() {
        try {
            ...
            const tickerData = await this.exchangeAPI.fetch24hrTicker();
            this.tickerData = this.exchangeAPI.format24hrTicker(tickerData);
    ...
    setSelectedSymbol(symbol) {
        ...
        if (selectedSymbolElement) {
            selectedSymbolElement.textContent = this.selectedSymbol;
        }
        
        console.log('Symbol set to:', this.selectedSymbol);
    }
